...
For more details on how Bounty Hunter uses action properties (e.g., the detectabilty and success of employed abilities), see "Advanced Configuration -> Bounty Hunter configuration".
For a practical example, see "Example Scenarios -> Varying detectability".