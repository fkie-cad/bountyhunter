...
To run this scenario, select the scenario in Bounty Hunter's UI tab or its configuration (`data/planners/e1bb9388-1845-495d-b67b-ad61a31ff6cd.yml`) to `demo_initial_access_and_priv_esc` . 
...
1. Configure fact `bountyhunter.ip_range`: Using the Caldera UI, configure the IP address range Bounty Hunter should scan initially. This is the only information we give to Bounty Hunter.
